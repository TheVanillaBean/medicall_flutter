...
import 'package:Medicall/models/tflite/camera_helper.dart';
...
class TfliteCam extends StatefulWidget {
  TfliteCam({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _TfliteCamPageState createState() => _TfliteCamPageState();
}

class _TfliteCamPageState extends State<TfliteCam>
