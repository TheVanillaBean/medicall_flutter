                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Text(
                                        'Your Images',
                                        style: TextStyle(
                                            fontWeight: currentDetailsIndex == 1
                                                ? FontWeight.bold
                                                : FontWeight.normal,
                                            color: currentDetailsIndex == 1
                                                ? Theme.of(context)
          ...
          child: Column(
            children: <Widget>[
              FormBuilder(
                ...
                child: Column(
                  children: <Widget>[
                    db.patientDetail != null && medicallUser.type == 'provider'
                        ? Row(
                            children: <Widget>[
                              Column(
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          padding: EdgeInsets.fromLTRB(10, 10, 0, 0),
                          child: FormBuilderDropdown(
                            initialValue: consultSnapshot.containsKey('refills')
                    ...
                    Row(
                      children: <Widget>[
                        Container(
                          ...
                          padding: EdgeInsets.fromLTRB(0, 10, 0, 0),
                          child: FormBuilderTextField(
                            initialValue: consultSnapshot.containsKey('dose') &&
                        ...
                        Container(
                          ...
                          child: FormBuilderTextField(
                            initialValue:
                                consultSnapshot.containsKey('frequency') &&
