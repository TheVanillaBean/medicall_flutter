...
import 'package:Medicall/screens/patient_flow/visit_details/prescription_checkout_view_model.dart';
        ...
        child: Column(
          children: [
            ...
            buildShippingAddressTextField(
              ...
              labelText: "City",
              hint: "Boston",
              errorText: model.shippingCityErrorText,
              enabled: model.isLoading == false,
            ...
            buildShippingAddressTextField(
              ...
              hint: "02101",
              enabled: model.isLoading == false,
              errorText: model.shippingZipCodeErrorText,
