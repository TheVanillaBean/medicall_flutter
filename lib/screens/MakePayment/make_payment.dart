              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Please confirm your payment details and pay below for your consult with Dr. ${this.model.consult.providerUser.fullName}, ${this.model.consult.providerUser.professionalTitle}",
